...
| Read more | [Catalog of Elixir refactorings](https://github.com/lucasvegi/Elixir-Refactorings?tab=readme-ov-file#rename-an-identifier) |
| Notes | $${\color{lightyellow} ⚠️ Renaming a public `function` only affects the current file}$$ |
...
| Read more | [Catalog of Elixir refactorings](https://github.com/lucasvegi/Elixir-Refactorings?tab=readme-ov-file#rename-an-identifier) |
| Notes | $${\color{lightyellow} ⚠️ Renaming a public `guard` only affects the current file}$$ |
