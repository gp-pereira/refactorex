...
| Read more | [Catalog of Elixir refactorings](https://github.com/lucasvegi/Elixir-Refactorings?tab=readme-ov-file#rename-an-identifier) |
| Notes | :warning: $\color{yellow}{\text{Renaming a public}}$ `function` $\color{yellow}{\text{only affects the current file}}$ |
...
| Read more | [Catalog of Elixir refactorings](https://github.com/lucasvegi/Elixir-Refactorings?tab=readme-ov-file#rename-an-identifier) |
| Notes | :warning: $\color{yellow}{\text{Renaming a public}}$ `guard` $\color{yellow}{\text{only affects the current file}}$ |
